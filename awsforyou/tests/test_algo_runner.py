...
class TestAlgoRunner(unittest.TestCase):
    def test_find_data_target(self):
        ...
        test_string = "run_mnist(data_loc='mnist_data/mnist_data_20k.csv', " \
                      "target_loc='mnist_data/mnist_target_20k.csv')"
        data, target = algo_runner.find_data_target(test_string)
        self.assertTrue(data == "mnist_data/mnist_data_20k.csv")
        self.assertTrue(target == "mnist_data/mnist_target_20k.csv")

        test_string = "run_mnist(target_loc='mnist_data/mnist_target_20k.csv', " \
    ...
    def test_algo_runner(self):
        ...
        times, percents = algo_runner.algo_runner("run_mnist(data_loc='data/"
                                                  "mnist_data/mnist_data_20k.csv',"
                                                  "target_loc='data/mnist_data/"
